...
# BUILD TEST SETS
# ------------------------
print("🧪 Creating similarity-based one-shot test sets...")
...
save_json(
    ...
    f"{BASE_DIR}/one-shot/similarity/en-de/test.json"
)

save_json(
    test_de_en_with_demo,
    f"{BASE_DIR}/one-shot/similarity/de-en/test.json"
)

print("✅ Done.")
print(f"📁 Files written to: {BASE_DIR}/one-shot/similarity/")
