...
# ------------------------
# CREATE TEST SET WITH RANDOM TWO-SHOT DEMOS
# ------------------------
def create_test_with_random_demos(
    ...
    for ex in tqdm(test_data):
        ...
        # Random TWO distinct validation examples per test instance
...
# ------------------------
# BUILD TEST SETS WITH TWO-SHOT DEMOS
# ------------------------
print("🧪 Creating test sets with random two-shot in-context examples...")
...
save_json(
    ...
    f"{BASE_DIR}/two-shot/random/en-de/test.json"
)

save_json(
    test_de_en_with_demo,
    f"{BASE_DIR}/two-shot/random/de-en/test.json"
)
